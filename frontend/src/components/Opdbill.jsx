              ...
              <div className="grid grid-cols-12 gap-x-4">
                ...
                <div className="col-span-7">
                  <div className="grid grid-cols-[80px_10px_1fr]">
                    <span>ReceiptNo.</span> <span>:</span>{" "}
                    <span>{bill.billNo || bill._id?.substring(0, 8)}</span>
                    ...
                    <span className="uppercase">
                      {patient.name}{" "}
                      {patient.fatherName ? `S/O ${patient.fatherName}` : ""}
                    </span>
            ...
            <div className="py-2 min-h-[60px]">
              {bill.services &&
                bill.services.map((service, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-[1fr_3fr_2fr_1fr] text-xs font-medium text-gray-700 mb-1"
                  >
